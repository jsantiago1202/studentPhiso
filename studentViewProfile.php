<?php 
    ...
    if(isset($_POST['update']))
    {
      ...
      $query = "UPDATE tbl_user SET name = '$name', password = '$password', contact = '$contact', address = '$address' WHERE id = '$studID'";
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Update Student Profile</h1>
          </div><!-- /.col -->
          <div class="col-sm">
          </div>
          <div class="col-sm">
    ...
    <section class="content">
      ...
      <div class="container-fluid">
        ...
        <!-- displaying to edit the profile -->
          <div class="col-sm">
              <form action="" method="post">
                ...
                <button type="submt" name="update">Update Profile</button>
