<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        $sql = "insert into tbl_studentConsultation(name,username,school,contact,address,date,concern,studID,status,acceptBy,comment) values('$name','$username','$school','$contact','$address','$date','$concern','$studID','Pending','Pending','Pending')";
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        ...
        <li class="nav-item">
          ...
          <li class="nav-item">
            <a href="studentBlog.php?ID=<?php echo $studentID?>" class="nav-link">
