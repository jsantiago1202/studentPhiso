  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Installment Payments</h1>
          </div><!-- /.col -->
          <div class="col-sm">
        ...
        <div class="row">
            <div class="col-sm">
                <form action="" method="post">
                    ...
                    School: 
                    <input type="text" name="school" value="<?php echo $rows['school'];?>" readonly><br><br>

                    Prelim Payment Amount: 
                    <input type="text" name="amount" required><br><br>

                    Prelim Reference No: 
                    <input type="text" name="referece" required><br><br>

                    <br><br>
                    Midterm Payment Amount: 
                    <input type="text" name="amount"  disabled="disabled"><br><br>

                    Midterm Reference No: 
                    <input type="text" name="referece" disabled="disabled"><br><br>


                    <br><br>
                    Prefinals Payment Amount: 
                    <input type="text" name="amount" disabled="disabled"><br><br>

                    Prefinals Reference No: 
                    <input type="text" name="referece" disabled="disabled"><br><br>


                    <br><br>
                    Finals Payment Amount: 
                    <input type="text" name="amount" disabled="disabled"><br><br>
