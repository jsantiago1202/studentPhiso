<?php 
    ...
    $savings = "SELECT name,SUM(savings) AS totals FROM tbl_studentpay where studID = '$studID'";
    $savingss = $con->query($savings) or die($con->error);
    $rowSavings = $savingss->fetch_object();
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm">
          <h2>Savings: <?php echo $rowSavings->totals;?></h2>
          </div>
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
