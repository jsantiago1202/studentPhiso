  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="container-fluid">
        <div class="row">
        <div class="col-sm">
            <!-- lagay ka logo --><h1>Student Future Works: Php 20,000</h1> 
            <h4>(Savings and Health)</h4><br>
            <h5>Face Value: Php 20,000</h5>
            <h5>Policy #:  SZEEJ8000001908</h5>
            <h3>-----------------------------</h3>
            <h5>Date Created: 01/01/20</h5>
          </div>

          <div class="col-sm">
          <h3>Amount: Php 625.00 Per Quarter</h3>
